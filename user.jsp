...
<body>
    ...
    <br>
     <% 
         ...
         String number=(String)session.getAttribute("userNumber");
                        ...
                        <div class="card-title mb-4">
                            <div class="d-flex justify-content-start">
                                ...
                                <div class="userData ml-3">
                                    ...
                                    <h6 class="d-block"><a href="javascript:void(0)">91+ </a><% out.print(number); %></h6>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="basicInfo-tab" data-toggle="tab" href="#basicInfo" role="tab" aria-controls="basicInfo" aria-selected="true">My orders</a>
                                    </li>
                                    <li class="nav-item">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-6">
                                                ...
                                                try{
                                                  ...
                                                  ResultSet rs=stmt.executeQuery("select * from orders WHERE phoneNumber='"+number+"'");
                                                    while(rs.next()){
                                                        String proname=rs.getString(1);
                                                        String kilo=rs.getString("killogram");
                                                        String price=rs.getString("price");
                                                        String dt=rs.getString("dateAndTime");
                                                        String pk=rs.getString("Productkey");
